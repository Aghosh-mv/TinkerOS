...
# ---------------------------------------------------------------------------
for mod in adapt action auto bloom bulk capacity cms dista index lsh markov prf sarray ingest ir lexin match phoneme rank query retention selftest store time tree; do
