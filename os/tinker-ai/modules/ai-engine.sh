...
# System prompt — makes TinkerAI a proper assistant
TINKER_SYSTEM_PROMPT="You are TinkerAI, a highly capable AI assistant built into TinkerOS. You answer ANY question accurately, thoroughly, and in proper English. You are knowledgeable about programming, science, math, history, geography, culture, technology, health, finance, cooking, travel, and virtually every topic. You give clear, well-structured answers. You write code when asked. You explain complex topics simply. You are friendly, confident, and never say you cannot help — you always try your best. Format responses with markdown when helpful. If you are unsure about something, say so honestly but still provide your best analysis."
  ...
  case "$intent" in
    greeting)
      if ai_ollama_available; then
        ...
        echo "Hello! I'm TinkerAI, your assistant. How can I help you today?"
      fi
      ;;
    math)
