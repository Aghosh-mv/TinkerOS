...
AI_SCRIPT = os.path.join(AI_DIR, "parc-ai.sh")
...
class Engine(QObject):
    """Async wrapper around parc-ai.sh CLI."""
    ...
    def _do_query(self):
        ...
        try:
            ...
            self.error.emit("parc-ai.sh not found at " + AI_SCRIPT)
...
class TinkeriaWindow(QMainWindow):
...
def main():
    if "--selftest" in sys.argv:
        print("  parc-ai-gui: syntax check pass")
        return 0
